...
//reseteamos los pathfinders
    ...
    public COcelot(RPGMob rpgm, World world, Location loc) {
        super(world);
        setSize(0.6F, 0.7F);
        ((Navigation) getNavigation()).a(true);
        this.baby=((RPGOcelot)rpgm).isBaby();
        this.catType=((RPGOcelot)rpgm).getoType();
        ...
        this.setBaby(baby);
        this.setCatType(this.catType.getNumber());
