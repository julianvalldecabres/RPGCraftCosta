 ...
 * @author jail
 */
public class CEndermite extends EntityMonster implements IRangedEntity {
    ...
    //VARIABLES PROPIAS DEL ENTITYENDERMITE
    private int a = 0;
...
//reseteamos los pathfinders
    ...
    public CEndermite(RPGMob rpgm, World world, Location loc) {
        super(world);
        this.b_ = 3;
        setSize(0.4F, 0.3F);
