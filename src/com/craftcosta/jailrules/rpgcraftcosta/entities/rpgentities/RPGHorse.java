...
public class RPGHorse extends RPGMob{
     ...
     * @param htype
     */
    public void setHtype(HorseType htype) {
        this.htype = htype;
    }
     ...
     * @return
     */
    public HorseVariant gethVariant() {
        return hVariant;
    }
     ...
     * @param hVariant
     */
    public void sethVariant(HorseVariant hVariant) {
        this.hVariant = hVariant;
    }
}
