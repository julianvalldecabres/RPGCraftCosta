...
public class RPGCreeper extends RPGMob{
    ...
    public RPGCreeper(int level, String name, CustomEntityType type, AttackType aType, MobBehaviour mType, double damageattack, double movementspeed, double knockback, double followrange, double maxhealth, double attackspeed, double rangeddamage, float rangedstrength, double money, double exp, double ap) {
        this.level = level;
        this.name = name;
        this.type = type;
        this.aType = aType;
